...
| threatTypes     | List       | Required: Json array of the threats.
| platformTypes   | List       | Required: Json array of the platforms types.
...
| threatTypes     | List       | Required: Json array of the threats.
| platformTypes   | List       | Required: Json array of the platforms types.
| threatEntryTypes| List       | Required: Json array of the threat entries types.
...
| supportedCompressions| List       | Required: Json array. The compression types supported by the client.
...
| clientId        | String     | Required: A client ID that (hopefully) uniquely identifies the client implementation of the Safe Browsing API.
| clientVersion   | String     | Required: The version of the client implementation.
| clientStates    | List       | Required: Json array. The current client states for each of the client's local threat lists.
| threatTypes     | List       | Required: Json array. The threat types to be checked.
| platformTypes   | List       | Required: Json array. The platform types to be checked.
| threatEntryTypes| List       | Required: Json array. The entry types to be checked.
