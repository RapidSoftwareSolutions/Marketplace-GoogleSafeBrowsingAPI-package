...
$app->post('/api/GoogleSafeBrowsingAPI/checkSingleUrlSafety', function ($request, $response, $args) {
    ...
    if(empty($post_data['args']['threatEntry'])) {
        $error[] = 'threatEntry';
    }
    ...
    $query_str = 'https://safebrowsing.googleapis.com/v4/threatMatches:find?key='.$post_data['args']['apiKey'];
    ...
    $body['threatInfo']['threatEntries'][] = ["url" => $post_data['args']['threatEntry']];
